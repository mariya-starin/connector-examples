...
public class IncrementSourceTask extends SourceTask {
    ...
    public void start(Map<String, String> props) {
        // retrieve all the config settings created in IncrementSourceConnector
    ...
    public List<SourceRecord> poll() throws InterruptedException {
         ...
         * e.g. an AvroConverter can now write the schema data to schema registry, and serialize
